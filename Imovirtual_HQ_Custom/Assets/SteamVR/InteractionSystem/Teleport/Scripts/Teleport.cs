...
namespace Valve.VR.InteractionSystem
{
	...
	public class Teleport : MonoBehaviour
    {
		...
		//-------------------------------------------------
		protected virtual bool WasTeleportButtonReleased( Hand hand )
		{
			if ( IsEligibleForTeleport( hand ) && hand.handType == SteamVR_Input_Sources.LeftHand)
			{
				if ( hand.noSteamVRFallbackCamera != null )
				{
		...
		//-------------------------------------------------
		protected virtual bool IsTeleportButtonDown( Hand hand )
		{
			if ( IsEligibleForTeleport( hand ) && hand.handType == SteamVR_Input_Sources.LeftHand)
			{
				if ( hand.noSteamVRFallbackCamera != null )
		...
		//-------------------------------------------------
		protected virtual bool WasTeleportButtonPressed( Hand hand )
		{
			if ( IsEligibleForTeleport( hand ) && hand.handType == SteamVR_Input_Sources.LeftHand )
			{
				if ( hand.noSteamVRFallbackCamera != null )
