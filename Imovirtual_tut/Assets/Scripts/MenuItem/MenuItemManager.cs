...
public class MenuItemManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            menuManagerScript.PopulateMenuTeste();
        }

        MASSIVE.EditorUtilities.Separator();

        GUILayout.Label("");
        GUILayout.Label("Menu 1");
        menuManagerScript.CreateMenu(menuManagerScript.Menu1);

        MASSIVE.EditorUtilities.Separator();

        GUILayout.Label("");
        GUILayout.Label("Menu 2");
        menuManagerScript.CreateMenu(menuManagerScript.Menu2);
